...
// some variables to store the error constants
var (
	ErrInvalidHash         = errors.New("the encoded hash is not in the correct format")
	ErrIncompatibleVersion = errors.New("incompatible version of argon2")
)

// ArgonConfig represents configuration for argon2
...
// createPassword returns password that is created with argon2
...
// comparePassword returns boolean result, if true the password is match
...
// generateRandomBytes returns slice of bytes for salt component in a password
...
// decodeHash returns decoded hash
